...
from .api import API
from .util import string_to_padded_hex, md5_hashing
        ...
        if user_input is not None:
            ...
            if authenticated:
                ...
                return self.async_create_entry(
                    ...
                    data = {**transformed_input, "update_interval" : user_input["update_interval"]}   # 기존 transformed_input 에 update_interval을 추가해서 전달
                )
            else:
